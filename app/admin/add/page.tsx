  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-fade-in-up">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Agregar Nuevo Producto</h2>
      </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div>
              ...
              <input
                ...
                placeholder="Ej. Classic Wayfarer"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  name="image"
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                  placeholder="/glasses.png"
                  defaultValue="/glasses.png"
                />
              </div>
            </div>
          </div>
